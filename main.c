...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    sensor_init();    //Initialization of sensor variables, AD converter settings, settings of the timer used to obtain sensor values
                      //Defined in sensor.c
    ...
    int mode = 0;   //declaration of variable(= mode)
  ...
  while (1){
    //Mode selection
    mode = select_mode(mode);   //select_mode is defined in auxiliary.c

    switch(mode){
        case 0:
            //take standard value
            //It is convenient to perform this operation automatically at startup.
            //This is already happening in case1
            //Use this mode if you want to do it manually.
            printf("Mode 0: Get Base Value.\n");
            get_base();   //get base value to wall control. it is defined in sensor.c
        ...
        case 3:
            ...
            //driveU(PULSE_SEC_HALF);     //半区画のパルス分等速で走行
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|CW_CCW_L_Pin|CW_CCW_R_Pin|M3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin CW_CCW_L_Pin CW_CCW_R_Pin M3_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|CW_CCW_L_Pin|CW_CCW_R_Pin|M3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
